...
class TestES(unittest.TestCase):
    ...
    def test_ES(self):
        ...
        self.assertEqual(report.publicationTime.isoformat(), '2022-02-22T15:57:00+01:00')
        self.assertEqual(report.validTime.startTime.isoformat(), '2022-02-23T12:00:00+01:00')
        self.assertEqual(report.validTime.endTime.isoformat(), '2022-02-23T15:57:00+01:00')
        ...
        report = reports[1]
        self.assertEqual(report.validTime.startTime.isoformat(), '2022-02-22T15:57:00+01:00')
        self.assertEqual(report.validTime.endTime.isoformat(), '2022-02-23T12:00:00+01:00')
        ...
        self.assertRaises(AttributeError, getattr, report.dangerRatings[1].elevation, 'upperBound')
