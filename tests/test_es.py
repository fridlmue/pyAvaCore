...
class TestES(unittest.TestCase):
    ...
    def test_ES(self):
        ...
        self.assertEqual(report.publicationTime.isoformat(), '2022-03-01T16:19:00+01:00')
        self.assertEqual(report.validTime.startTime.isoformat(), '2022-03-01T16:19:00+01:00')
        self.assertEqual(report.validTime.endTime.isoformat(), '2022-03-02T16:19:00+01:00')
