...
class TestBavariaAmPm(unittest.TestCase):
    ...
    def test_bavaria_ampm(self):
        ...
        self.assertEqual(report.danger_main[0].valid_elevation, 'ElevationRange_2000Hi')
        self.assertEqual(report.danger_main[1].main_value, 1)
        self.assertEqual(report.danger_main[1].valid_elevation, 'ElevationRange_2000Lw')
