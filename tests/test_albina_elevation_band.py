...
class TestAlbinaElevationBand(unittest.TestCase):
    def test_albina_elevation_band(self):
        ...
        self.assertEqual(
            report.publicationTime.isoformat(), "2021-12-29T07:00:00+00:00"
        )
        self.assertEqual(
            report.validTime.startTime.isoformat(), "2021-12-28T23:00:00+00:00"
        )
        self.assertEqual(
            report.validTime.endTime.isoformat(), "2021-12-29T23:00:00+00:00"
        )
        ...
        self.assertRaises(
            AttributeError, getattr, report.dangerRatings[2].elevation, "upperBound"
        )
        ...
        self.assertRaises(
            AttributeError, getattr, report.dangerRatings[3].elevation, "lowerBound"
        )
