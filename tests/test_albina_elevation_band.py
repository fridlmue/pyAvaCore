...
class TestAlbinaElevationBand(unittest.TestCase):
    ...
    def test_albina_elevation_band(self):
        ...
        self.assertEqual(report.avalancheProblems[0].dangerRating.elevation.lowerBound, '1900')
        self.assertEqual(report.avalancheProblems[0].dangerRating.elevation.upperBound, '2400')
        ...
        self.assertIn('N', report.avalancheProblems[2].dangerRating.aspect)
        self.assertNotIn('S', report.avalancheProblems[2].dangerRating.aspect)
        self.assertEqual(report.avalancheProblems[2].dangerRating.elevation.upperBound, 'Treeline')
