...
class TestJsonSchema(unittest.TestCase):
    ...
    @pytest.mark.skip(reason="Test is designed for a local execution to ensure general compatibility agains JSON schema once.")
    def test_json_schema(self):
        ...
        for idx, regionID in enumerate(regions):
            ...
            bulletins_generic = json.loads(json.dumps(bulletins, cls=pyAvaCore.JSONEncoder, indent=2)) #ToDo find better way. Probably with JSONEncoder directly
