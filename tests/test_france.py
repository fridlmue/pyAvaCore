...
class TestFrance(unittest.TestCase):
    ...
    def test_france(self):
        ...
        self.assertIn('FR-22', report.region)
        self.assertNotIn('FR-10', report.region)
        self.assertEqual(report.dangerRating[0].mainValue, 'moderate')
        #self.assertEqual(report.dangerRating[0].valid_elevation, '<2200')
        self.assertEqual(report.dangerRating[0].elevation.upperBound, '2200')
        self.assertEqual(report.dangerRating[1].mainValue, 'considerable')
        #self.assertEqual(report.dangerRating[1].valid_elevation, '>2200')
        self.assertEqual(report.dangerRating[1].elevation.lowerBound, '2200')
