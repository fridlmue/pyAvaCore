...
class TestFrance(unittest.TestCase):
    ...
    def test_france(self):
        ...
        self.assertIn('E', report.customData['MeteoFrance']['avalancheProneLocation']['aspects'])
        self.assertIn('SE', report.customData['MeteoFrance']['avalancheProneLocation']['aspects'])
