...
class TestCtIcgc(unittest.TestCase):
    def test_ct_icgc(self):
        ...
        self.assertEqual(
            report.publicationTime.isoformat(), "2022-01-19T00:00:00+01:00"
        )
        self.assertEqual(
            report.validTime.startTime.isoformat(), "2022-01-20T00:00:00+01:00"
        )
        self.assertEqual(
            report.validTime.endTime.isoformat(), "2022-01-20T23:59:00+01:00"
        )
