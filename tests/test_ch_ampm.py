...
class TestCH(unittest.TestCase):
    def test_ch(self):
        reports = pyAvaCore.process_reports_ch(
        ...
        self.assertEqual(
            report.publicationTime.isoformat(), "2021-02-22T17:00:00+01:00"
        )
        self.assertEqual(
            report.validTime.startTime.isoformat(), "2021-02-22T17:00:00+01:00"
        )
        self.assertEqual(
            report.validTime.endTime.isoformat(), "2021-02-23T17:00:00+01:00"
        )
        ...
        self.assertEqual(
            report.customData["SLF"]["avalancheProneLocation"]["elevation"], "2400"
        )
        self.assertRaises(
        ...
        self.assertIn(
            "N", report.customData["SLF"]["avalancheProneLocation"]["aspects"]
        )
        self.assertIn(
            "NE", report.customData["SLF"]["avalancheProneLocation"]["aspects"]
        )
        self.assertIn(
            "W", report.customData["SLF"]["avalancheProneLocation"]["aspects"]
        )
        self.assertIn(
            "NW", report.customData["SLF"]["avalancheProneLocation"]["aspects"]
        )
        self.assertIn(
            "E", report.customData["SLF"]["avalancheProneLocation"]["aspects"]
        )
        self.assertNotIn(
            "SE", report.customData["SLF"]["avalancheProneLocation"]["aspects"]
        )
        self.assertNotIn(
            "S", report.customData["SLF"]["avalancheProneLocation"]["aspects"]
        )
        self.assertNotIn(
            "SW", report.customData["SLF"]["avalancheProneLocation"]["aspects"]
        )
        ...
        self.assertEqual(report.dangerRatings[0].mainValue, "moderate")
        self.assertEqual(
            report.customData["SLF"]["avalancheProneLocation"]["elevation"], "2200"
        )
        self.assertRaises(
            AttributeError, getattr, report.dangerRatings[0].elevation, "upperBound"
        )
