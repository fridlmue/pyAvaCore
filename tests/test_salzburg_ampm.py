...
class TestSalzburg(unittest.TestCase):
    ...
    def test_salzburg(self):
        ...
        self.assertEqual(report.avalancheProblems[0].terrainFeature, 'daytime cycle of naturally triggered avalanches')
        self.assertEqual(report.avalancheProblems[1].problemType, 'gliding_snow')
        self.assertEqual(report.avalancheProblems[1].terrainFeature, 'in extremely steep grass-covered terrain')
