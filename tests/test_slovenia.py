...
class TestSlovenia(unittest.TestCase):
    ...
    def test_slovenia(self):
        ...
        self.assertEqual(report.publicationTime.isoformat(), '2021-03-19T07:47:19')
        self.assertEqual(report.validTime.startTime.isoformat(), '2021-03-20T00:00:00')
        self.assertEqual(report.validTime.endTime.isoformat(), '2021-03-20T12:00:00')
        self.assertIn('SI1', report.region)
        self.assertNotIn('SI2', report.region)
        ...
        self.assertEqual(report.publicationTime.isoformat(), '2021-03-19T07:47:19')
        self.assertEqual(report.validTime.startTime.isoformat(), '2021-03-20T12:00:00')
        self.assertEqual(report.validTime.endTime.isoformat(), '2021-03-20T23:59:59')
        self.assertIn('SI3', report.region)
        self.assertNotIn('SI1', report.region)
        self.assertEqual(report.dangerRating[0].mainValue, 'low')
        # self.assertEqual(report.danger_main[0].valid_elevation, '<1700')
        self.assertEqual(report.dangerRating[0].elevation.upperBound, '1700')
        # self.assertEqual(report.dangerpattern, ['DP4'])
        ...
        self.assertEqual(report.bulletinID, 'BulletinSiID-SI1')
        self.assertEqual(report.publicationTime.isoformat(), '2021-03-19T07:47:19')
        self.assertEqual(report.validTime.startTime.isoformat(), '2021-03-21T00:00:00')
        self.assertEqual(report.validTime.endTime.isoformat(), '2021-03-21T12:00:00')
        self.assertIn('SI1', report.region)
        self.assertNotIn('SI2', report.region)
        self.assertEqual(report.dangerRating[0].mainValue, 'low')
        # self.assertEqual(report.danger_main[0].valid_elevation, '<1700')
        ...
        self.assertEqual(report.bulletinID, 'BulletinSiID-SI3_PM')
        self.assertEqual(report.publicationTime.isoformat(), '2021-03-19T07:47:19')
        self.assertEqual(report.validTime.startTime.isoformat(), '2021-03-21T12:00:00')
        self.assertEqual(report.validTime.endTime.isoformat(), '2021-03-21T23:59:59')
        self.assertIn('SI3', report.region)
        self.assertNotIn('SI1', report.region)
        self.assertEqual(report.dangerRating[0].mainValue, 'low')
        # self.assertEqual(report.danger_main[0].valid_elevation, '<1700')
