...
class TestSlovenia(unittest.TestCase):
    ...
    def test_slovenia(self):
        ...
        self.assertIn('SE', report.avalancheProblems[0].dangerRating.aspect)
        self.assertIn('W', report.avalancheProblems[0].dangerRating.aspect)
        self.assertNotIn('N', report.avalancheProblems[0].dangerRating.aspect)
        ...
        self.assertEqual(report.dangerRatings[1].elevation.lowerBound, '1700')
