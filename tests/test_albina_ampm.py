...
class TestAlbinaAmPm(unittest.TestCase):
    ...
    def test_albina_ampm(self):
        ...
        self.assertIn('IT-32-TN-15', report.region)
        self.assertNotIn('IT-32-BZ-01', report.region)
        self.assertEqual(report.dangerRating[0].mainValue, 'moderate')
        self.assertEqual(report.dangerRating[0].get_mainValue_int(),  2)
        self.assertEqual(report.dangerRating[0].elevation.lowerBound, '-')
        self.assertEqual(report.dangerRating[0].elevation.upperBound, '-')
        # self.assertEqual(report.dangerpattern, ['DP10'])
        self.assertEqual(report.avalancheProblem[0].problemType, 'wet snow')
        self.assertIn('S', report.avalancheProblem[0].dangerRating[0].aspect)
        self.assertEqual(report.avalancheProblem[1].problemType, 'gliding snow')
        self.assertIn('SW', report.avalancheProblem[1].dangerRating[0].aspect)
        self.assertNotIn('N', report.avalancheProblem[1].dangerRating[0].aspect)
        ...
        self.assertIn('AT-07-13', report.region)
        self.assertNotIn('AT-07-24', report.region)
        self.assertEqual(report.dangerRating[0].mainValue, 'moderate')
        self.assertEqual(report.dangerRating[0].get_mainValue_int(),  2)
        ...
        self.assertEqual(report.avalancheProblem[0].problemType, 'wet snow')
        self.assertIn('W', report.avalancheProblem[0].dangerRating[0].aspect)
        self.assertEqual(report.avalancheProblem[0].dangerRating[0].elevation.upperBound, '2600')
        self.assertEqual(report.avalancheProblem[1].problemType, 'drifting snow')
        self.assertIn('NE', report.avalancheProblem[1].dangerRating[0].aspect)
        self.assertNotIn('S', report.avalancheProblem[1].dangerRating[0].aspect)
        self.assertEqual(report.avalancheProblem[1].dangerRating[0].elevation.lowerBound, '2400')
