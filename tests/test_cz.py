...
class TestCZ(unittest.TestCase):
    def test_cz(self):
        with open(f"{__file__}.json") as fp:
            data = json.load(fp)
        cz_report = data
        reports = get_reports_fromjson(cz_report).bulletins
        ...
        self.assertEqual(
            report.publicationTime.isoformat(), "2022-03-15T07:48:00+01:00"
        )
        self.assertEqual(
            report.validTime.startTime.isoformat(), "2022-03-15T07:48:00+01:00"
        )
        self.assertEqual(
            report.validTime.endTime.isoformat(), "2022-03-16T07:48:00+01:00"
        )
        ...
        self.assertEqual(
            report.publicationTime.isoformat(), "2022-03-15T08:36:01+01:00"
        )
        self.assertEqual(
            report.validTime.startTime.isoformat(), "2022-03-15T08:36:01+01:00"
        )
        self.assertEqual(
            report.validTime.endTime.isoformat(), "2022-03-16T08:36:01+01:00"
        )
