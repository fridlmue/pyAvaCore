...
class TestCZ(unittest.TestCase):
    ...
    def test_cz(self):
        ...
        self.assertEqual(report.publicationTime.isoformat(), '2022-03-15T07:48:00')
        self.assertEqual(report.validTime.startTime.isoformat(), '2022-03-15T07:48:00')
        self.assertEqual(report.validTime.endTime.isoformat(), '2022-03-16T07:48:00')
        ...
        self.assertEqual(report.publicationTime.isoformat(), '2022-03-15T08:36:01')
        self.assertEqual(report.validTime.startTime.isoformat(), '2022-03-15T08:36:01')
        self.assertEqual(report.validTime.endTime.isoformat(), '2022-03-16T08:36:01')
        self.assertIn('CZ-06', report.get_region_list())
        self.assertNotIn('CZ-04', report.get_region_list())
        self.assertEqual(report.dangerRatings[0].mainValue, 'moderate')
        self.assertEqual(report.dangerRatings[0].get_mainValue_int(),  2)
        self.assertEqual(report.avalancheProblems[0].problemType, 'drifting_snow')
        self.assertRaises(AttributeError, getattr, report.avalancheProblems[0].dangerRating.elevation, 'upperBound')
