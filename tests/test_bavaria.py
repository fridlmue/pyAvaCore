...
class TestBavaria(unittest.TestCase):
    def test_bavaria(self):
        ...
        self.assertEqual(
            report.publicationTime.isoformat(), "2021-01-26T17:43:18+01:00"
        )
        self.assertEqual(
            report.validTime.startTime.isoformat(), "2021-01-27T00:00:00+01:00"
        )
        self.assertEqual(
            report.validTime.endTime.isoformat(), "2021-01-27T23:59:59+01:00"
        )
