...
class TestVorarlberg(unittest.TestCase):
    def test_vorarlberg(self):
        ...
        self.assertEqual(
            report.publicationTime.isoformat(), "2021-02-23T07:30:00+01:00"
        )
        self.assertEqual(
            report.validTime.startTime.isoformat(), "2021-02-23T07:30:00+01:00"
        )
        self.assertEqual(
            report.validTime.endTime.isoformat(), "2021-02-23T12:00:00+01:00"
        )
        ...
        self.assertEqual(report.dangerRatings[1].elevation.upperBound, "2200")
        ...
        self.assertEqual(
            report.validTime.startTime.isoformat(), "2021-02-23T12:00:00+01:00"
        )
        self.assertEqual(
            report.validTime.endTime.isoformat(), "2021-02-24T07:30:00+01:00"
        )
        self.assertIn("AT8R5", report.get_region_list())
        self.assertNotIn("AT8R1", report.get_region_list())
        self.assertEqual(len(report.dangerRatings), 1)
        self.assertEqual(report.dangerRatings[0].mainValue, "moderate")
        self.assertRaises(
